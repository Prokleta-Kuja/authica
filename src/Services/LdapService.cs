...
namespace authica.Services
{
    public class LdapService : BackgroundService
    {
        ...
        static HashSet<TcpClient> s_clients = new();
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            while (s_server.Server.IsBound)
                try
                {
                    var client = await s_server.AcceptTcpClientAsync();
                    ...
                    case 0: // Bind
                        ...
                        if (authentication.TagValue != C.Ldap.Tags.AuthenticationSimple.TagValue)
                        {
                            ...
                            using (unsupportedWriter.PushSequence())
                            {
                                ...
                                unsupportedWriter.WriteOctetString(System.Text.Encoding.UTF8.GetBytes("")); // Matched DN
                                unsupportedWriter.WriteOctetString(System.Text.Encoding.UTF8.GetBytes("")); // Diagnostic message
