...
public partial class AppEdit : IDisposable
{
    ...
    private readonly Dictionary<Guid, Role> _appRoles = new();
    ...
    async Task SaveCreateClicked()
    {
        ...
        _errors = _create.Validate(_t, _names, C.Configuration.Current.MinPasswordLength, C.Configuration.Current.MaxPasswordLength);
        if (_errors != null)
            return;
    ...
    async Task SaveEditClicked()
    {
        ...
        _errors = _edit.Validate(_t, _names, C.Configuration.Current.MinPasswordLength, C.Configuration.Current.MaxPasswordLength);
        if (_errors != null)
            return;
