...
public partial class UserEdit : IDisposable
{
    ...
    private readonly Dictionary<Guid, Role> _userRoles = new();
    ...
    async Task SaveCreateClicked()
    {
        ...
        _errors = _create.Validate(_t, _emails, _names, C.Configuration.Current.MinPasswordLength, C.Configuration.Current.MaxPasswordLength);
        if (_errors != null)
            return;
    ...
    async Task SaveEditClicked()
    {
        ...
        _errors = _edit.Validate(_t, _emails, _names, C.Configuration.Current.MinPasswordLength, C.Configuration.Current.MaxPasswordLength);
        if (_errors != null)
            return;
