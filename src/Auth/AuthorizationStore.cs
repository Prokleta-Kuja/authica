...
public class AuthorizationStore
{
    ...
    static readonly Dictionary<Guid, int> s_appAliasIds = new();
    static readonly Dictionary<Guid, int> s_userAliasIds = new();
    static readonly Dictionary<string, int> s_appEndpointIds = new();
    static readonly Dictionary<string, int> s_appNameIds = new();

    static readonly Dictionary<int, HashSet<int>> s_appUsers = new();
    static readonly Dictionary<int, HashSet<LdapEntryModel>> s_appLdapEntires = new();
